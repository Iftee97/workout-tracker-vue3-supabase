  ...
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <form class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg" @submit.prevent="register">
      ...
      <div class="flex flex-col mb-2">
        ...
        <input class="p-2 text-gray-500 focus:outline-none" type="email" id="email" v-model="email" required />
      </div>

      <div class="flex flex-col mb-2">
        <label for="password" class="mb-1 text-sm text-at-light-green"> Password </label>
        <input class="p-2 text-gray-500 focus:outline-none" type="password" id="password" v-model="password" required />
      </div>

      <div class="flex flex-col mb-2">
        <label for="password" class="mb-1 text-sm text-at-light-green"> Confirm Password </label>
        <input class="p-2 text-gray-500 focus:outline-none" type="password" id="confirmPassword" v-model="confirmPassword" required />
      </div>
